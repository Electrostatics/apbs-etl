...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            0.0,
            True,
            "elec mg-para dime 0 0 0 pdime 0 0 0 ofrac 0.1 cglen 0.0000 0.0000 0.0000 fglen 0.0000 0.0000 0.0000 cgcent mol 1 fgcent mol 1 mol 1 lpbe bcfl sdh pdie 2.0000 sdie 78.5400 srfm smol chgm spl2 sdens 10.00 srad 1.40 swin 0.30 temp 298.15 calcenergy total calcforce no write pot dx test3 end",
        ...
        pytest.param(
            ...
            0.0,
            True,
            "elec mg-manual dime 0 0 0 glen 0.000 0.000 0.000 gcent mol 1 mol 1 lpbe bcfl sdh pdie 2.0000 sdie 78.5400 srfm smol chgm spl2 sdens 10.00 srad 1.40 swin 0.30 temp 298.15 calcenergy total calcforce no write pot dx test4 end",
